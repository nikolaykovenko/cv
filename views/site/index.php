...
<?php foreach ($this->context->categories as $category): ?>
    <section class="main-section">
        ...
        <?php if ($category->skills_matrix): ?>
            ...
            <aside class="note">
                <p>* Skill level: 1 – Theoretical knowledge; 2 - Junior; 3 – Confirmed experience; 4 – Advanced
                    experienced; 5 – Senior expert.</p>
            </aside>
        <?php else: ?>
            <dl>
                <?php foreach ($category->parameterValues as $param): ?>
                    <dt><?= $param->caption ?></dt>
